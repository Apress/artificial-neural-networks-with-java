// ===============================================================
// Approximation spiral-like Fiunction using conventional process.
...
public class Sample5b implements ExampleChart<XYChart>
{
  ...
  public XYChart getChart()
    ...
    try
       {
         ...
         //trainFileName = "C:/My_Neural_Network_Book/Book_Examples/Sample8_Calculate_Train_Norm.csv";   
         // chartTrainFileName = "C:/My_Neural_Network_Book/Book_Examples/Sample8_Chart_ComplexFormula_Spiral_Train_Results.csv";   
         ...
         networkFileName = "C:/My_Neural_Network_Book/Book_Examples/Sample8_Saved_Network_File.csv";
   ...
   public static void main(String[] args)
    {
      ExampleChart<XYChart> exampleChart = new Sample5b();
   ...
   static public double trainValidateSaveNetwork()
    {
	 ...
	 System.out.println("Epoch #" + epoch + " Error:" + train.getError());
         ...
         if (epoch >= 11000 && network.calculateError(trainingSet) > 0.2251)    // 0.0671   0.121
             { 
              returnCode = 1;
       ...
       } while(train.getError() > 0.225);  // 0.067  0.12
